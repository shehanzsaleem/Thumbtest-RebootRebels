                            ...
                            function extractFrames(video_url) {
                                ...
                                function onend(e) {
                                    ...
                                    for (var i = 0; i < array.length; i++) {
                                        ...
                                        document.getElementById("selected-image" + (Math.round((i / gap)))).src = img.src;
                                        // document.body.appendChild(img);
                                    }
                                ...
                                async function loadTumbnailModel() { //Progress bar and Loading of the Model
                                    // $('.progress-bar').show();
